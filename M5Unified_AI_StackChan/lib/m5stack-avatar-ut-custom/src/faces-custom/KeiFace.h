...
namespace m5avatar
{
  ...
  public:
    ...
    void draw(M5Canvas *spi, BoundingRect rect, DrawContext *ctx)
    {
      ...
      if (openRatio > 0)
      {
        ...
        if (exp == Expression::Happy || exp == Expression::Doubt)
        {
  ...
  */
  ...
  public:
    KeiFace()
        : Face(new KeiMouth(50, 70, 11, 50), new BoundingRect(198, 160),
               new KeiEye(30, false), new BoundingRect(118, 56),
               new KeiEye(30, true), new BoundingRect(118, 264),
